...
f=rgb2gray(imread('E:\IIIT Delhi Course\Semester 5\IA - Image Analysis\Number_Plate_Extraction\Number_Plate_Extraction\carplate2.jpg'));
BW = imbinarize(f, 0.3);
figure, imshow(f)
% X - 23 to 600
% Y - 149 to 306
%XStart = input('Start of X - ')
BW = BW(149:306, 23:600);
figure, imshow(BW)
Column = [];
%Count = 0;
L = [];
...
CharImg = CharImg(XPoint(1):XPoint(2), :);
imshow(CharImg);
